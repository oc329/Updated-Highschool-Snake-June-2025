...
TOTAL_COLUMNS = 40
TOTAL_ROWS = 20
BLOCK_SIZE = (SCREEN_WIDTH // TOTAL_COLUMNS, SCREEN_HEIGHT // TOTAL_ROWS)
CELL_WIDTH, CELL_SIZE = BLOCK_SIZE
...
GRID_POS_TO_DISPLAY_POS = tuple([
    [(col * BLOCK_SIZE[0], row * BLOCK_SIZE[1]) for col in range(TOTAL_COLUMNS)]
