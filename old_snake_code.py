...
class Snake(ScreenObject, Updatable):
    ChainChompSkin = SnakeSkin(image_folder_name = "Chain Chomp")
    RedSkin = SnakeSkin(colors = (RED,), retro_effect = True)
    RainbowSkin = SnakeSkin(colors = SIMPLE_RAINBOW, retro_effect = True)
